...
pub struct TokenBudgetConfig {
    pub use_history_notes_history: bool,
...
impl Default for TokenBudgetConfig {
    fn default() -> Self {
        Self {
            use_history_notes_history: false,
...
fn resolve_token_budget_config(
    ...
    let use_history_notes_history = token_budget_config
        .and_then(|config| config.use_history_notes_history)
        .unwrap_or_default();
